# Abhinav Padige - AI Engineer & Full Stack Developer Portfolio

A modern, dark-themed personal portfolio website showcasing Abhinav Padige's expertise in AI/ML, full-stack development, and cloud technologies.

## 🚀 Live Demo

[https://abhinav-padige-portfolio.vercel.app](https://abhinav-padige-portfolio.vercel.app)

## ✨ Features

- **Dark Theme with Glassmorphism**: Elegant dark UI with frosted glass effects and purple-pink gradients
- **Responsive Design**: Optimized for all device sizes (mobile, tablet, desktop)
- **Smooth Animations**: Subtle hover effects, transitions, and scale transformations
...
- **Optimized Performance**: Fast loading with code splitting and asset optimization
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/abhinavpadige/portfolio.git
   cd portfolio
   ```
...
- Secondary: `bg-gray-800/50` (glassmorphism background)
- Accent: `text-white` and `hover:text-white`
- Status: `text-green-400` (success), `text-red-400` (error)

### Effects
- Glassmorphism: `bg-white/10 backdrop-blur-sm`
- Hover: `hover:scale-[1.02]`, `hover:from-9333ea hover:to-f472b6`
- Transitions: `transition-all duration-300`
- Shadows: `rounded-lg` with subtle elevation
...
- Special thanks to the open-source community for Tailwind CSS, React, and Vite
...
*Developed by Abhinav Padige | AI Engineer & Full Stack Developer*
